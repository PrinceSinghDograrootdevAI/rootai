...
const technologies = [
  ...
  { name: "PyTorch",  position: { top: '20px', left: '20%' }, rotate: 8.28 },
  ...
  { name: "PyTorch", color: "BLACK", position: { top: '110px', left: '6%' }, rotate: 10.28 },
  { name: "Scikit-learn", color: "white", border: "orange", position: { top: '130px', left: '22.5%' }, rotate: -23 },
  { name: "TensorFlow", color: "WHITE", position: { top: '91px', left: '49%' }, rotate: 4 },
  { name: "LLM", color: "black", position: { top: '148px', left: '40%' }, rotate: 20 },
  { name: "LLM", color: "black", position: { top: '165px', left: '58%' }, rotate: -18 },
  { name: "Tensorflow", color: "white", position: { top: '210px', left: '3%' }, rotate: -18 },
  { name: "PyTorch", color: "white", position: { top: '210px', left: '30%' }, rotate: 0 },
];
