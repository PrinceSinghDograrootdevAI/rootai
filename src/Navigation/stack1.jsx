...
const Stack = () => {
  return (
    <div className="stack-outer-wrapper">
      <div className="stack-rotated-div">
        <div className="stack-container">
          <div className="stack-header">
            <button className="our-tool-btn">Our Tools</button>
            <h2>
              <span className="highlight">Our Prime </span>
              <span className="blue-text">Technology Stack</span>
            </h2>
            <p className="stack-subheading">
              Smart Automation. Real Results. Combat Solutions builds next-gen AI agents that streamline operations,
              boost productivity, and cut costs — from intelligent chatbots to fully automated workflows.
            </p>
          </div>
